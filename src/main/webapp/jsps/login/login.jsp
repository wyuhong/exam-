...
<BODY>
	...
	<DIV
		...
		<form id="login" action="<c:url value='/login.do'/>" method="post">
		...
		<input type="radio"  name="type" value=0 checked="checked">管理员登录
		&nbsp;&nbsp;&nbsp;&emsp;<input type="radio"  name="type" value=1>学生登录		
		<DIV
			...
			<P style="margin: 0px 35px 20px 45px;">
				 <SPAN
					...
					href="javascript:$('#login').submit();">登录</A> </SPAN>
			</P>
			
		</DIV>
		</form>
	</DIV>
<script type="text/javascript" src="<c:url value='/jsps/login/js/mylogin.js'/>"></script>
</BODY>
</html>